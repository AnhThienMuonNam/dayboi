var MainModel = function (data) {
    //properties
    var self = this;
    self.courseModel = new CourseModel(data);
}

var CourseModel = function (data, parent) {
    //properties
    var self = this;
    ...
    if (data && data.Course) {
        ko.mapping.fromJS(data.Course, {}, self);
    }
    ...
    self.create = function () {
        ...
        var course = self.toJSON();
        $.ajax({
            url: data.API_URLs.CreateCourse,
            type: "POST",
            data: { model: course },
    ...
    self.update = function () {
        ...
        var course = self.toJSON();
        $.ajax({
            url: data.API_URLs.UpdateCourse,
            type: "POST",
            data: { model: course },
            success: function (response) {
                if (response.IsSuccess == true)
